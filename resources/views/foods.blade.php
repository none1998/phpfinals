    ...
    <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center sm:pt-0">
            ...
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="ml-4 text-lg leading-7 font-semibold"></br>
                    <button align="center" type="button" onclick="location.href = '/foods/create'" style="
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2">
                        <div class="p-6">
                            ...
                            <div class="ml-4 text-lg leading-7 font-semibold">
                                <a href="{{route('foods.edit',$food->id)}}" class="text-sm text-gray-700 underline" style="
                        float: left;
                        margin-left: 6.1%;
                        color: #fff !important;
                        text-transform: uppercase;
                        ...
                        display: inline-block;
                        border: none;
                        transition: all 0.4s ease 0s;">Edit</a>
                                <i class="fa fa-pencil-square"></i>
                            </div>
                            <div class="ml-4 text-lg leading-7 font-semibold">
                                <form method="post" enctype="multipart/form-data" action="{{route('foods.delete',$food->id)}}">
                                    @csrf
                                    @method('DELETE')
                        ...
                        display: inline-block;
                        border: none;
                        transition: all 0.4s ease 0s;">Delete</button>
                                    </br>
                                </form>
                            </div>
                            <div class="ml-12">
